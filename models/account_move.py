...
class AccountMove(models.Model):
    ...
    # 202207121329 EOG-ASP: FEAT se asigna cuando sea traslado el emisor es igual que el receptor
    @api.onchange('type_cfdi')
    def _onchange_type_cfdi(self):
        if self.type_cfdi == 'T' and self.move_type == 'out_invoice':
            self.partner_id = self.company_id.partner_id.id
        self.usocfdi_id = self.env['uso.cfdi'].search([('code','=','S01')],limit=1).id
        ...
        if self.transport==True:
            ...
            if self.transport:
                ...
                for line in self.transport_line_ids:
                    ...
                    # 202207111534 Ernesto Orozco ASP: FIX, se elimina asignacion en hardcode de BienesTransp
                    ...
                    mercancias.append({'cartaporte20:Mercancia':{'BienesTransp':line.product_code_sat_id.code_sat,'Cantidad':line.quantity,
                        'ClaveUnidad':line.product_uom_sat_id.code_sat,'Descripcion':line.product_code_sat_id.name,'PesoEnKg':"{0:.3f}".format(line.weight_kg),
                        'ValorMercancia':line.price_subtotal,'Moneda':self.currency_id.name}})
                complemento['cfdi:Complemento'].update({
                    ...
                    ##a cambiar
                        ...
                        'NumeroExterior':self.company_id.partner_id.street_number,
                        'Pais':'MEX',
                    ...
                    'FechaHoraSalidaLlegada':str(self.date_planned.isoformat()),
                        ...
                        'Municipio':self.partner_receiver_id.city_id.code,'NumeroExterior':self.partner_receiver_id.street_number,
    ...
    def _onchange_fleet_id(self):
        if self.fleet_id:
            ...
            self.operator_vat=self.fleet_id.driver_id.vat
